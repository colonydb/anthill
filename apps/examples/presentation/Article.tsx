...
import Article from "@colonydb/anthill/presentation/Article";
...
export const Default = () => (
  <Article>
    ...
    <img src="https://fillmurray.lucidinternets.com/304/456" alt="" />
    <pre>codeblock</pre>
    <figure>
      <img src="https://fillmurray.lucidinternets.com/456/304" alt="" />
      <figcaption>
    ...
    <p>
      ...
      <i>italic</i>{" "}
      {(["strong", "b"] as const).map((Bold) =>
        (["em", "i"] as const).map((Italic) => (
