              ...
              value: [
                {
                  id: "1",
                  value: (
                    <Chip icon={GanttChartIcon} hue={272} onRemove={action("onRemove")}>
                      Aperiam Dicta Sint
                    </Chip>
                  ),
                },
              ...
              value: [
                {
                  id: "1",
                  value: (
                    <Chip icon={GanttChartIcon} hue={4} onRemove={action("onRemove")}>
              ...
              value: [
                {
                  id: "1",
                  value: (
                    <Chip icon={GanttChartIcon} hue={23} onRemove={action("onRemove")}>
              ...
              value: [
                {
                  id: "1",
                  value: (
                    <Chip icon={GanttChartIcon} hue={312} onRemove={action("onRemove")}>
